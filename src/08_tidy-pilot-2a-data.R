...
write_csv(data_patients, "data/external/data_patients_pilot2a.csv")
...
write_csv(data_inpt_abx, "data/external/data_inpatient_abx_pilot2a.csv")
write_csv(data_dc_abx, "data/external/data_discharge_abx_pilot2a.csv")
